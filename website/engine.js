...
function TextToColor(textmap) {
  ...
  var textColor = new Map(Object.entries({
      "IonCompilation": "green",
      "IonLinking": "green",
      "YarrCompile": "#BE8CFF",
      "YarrJIT": "#BE8CFF",
      "YarrInterpreter": "#BE8CFF",
      "MinorGC": "#CCCCCC",
      "GC": "#666666",
      "GCSweeping": "#666666",
      "GCAllocation": "#666666",
      ...
      "Baseline": "#FFE75E",
      "IonMonkey": "#54D93D",
      "ParserCompileScript": "#DB0000",
      "ParserCompileLazy": "#A30000",
      "ParserCompileFunction": "#CC8585",
      "VM": "#00aaff"
    }));
  ...
  for(var i=0; i<textmap.length; i++) {
    var color = textColor.get(textmap[i]);
    if (!color) {
